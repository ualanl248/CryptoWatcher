...
# source: https://github.com/richardkiss/pycoin/blob/main/pycoin/contrib/ripemd160.py
...
if struct.calcsize("<L") != 4 or struct.calcsize("<Q") != 8:
    raise RuntimeError("unexpected struct sizes")
